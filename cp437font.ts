const cp437_font:number[][] = [
  ...
  [ 0x00003C3C, 0x447E0000 ],   /*"a",0*/
  [ 0x40407844, 0x44780000 ],   /*"b",1*/
  [ 0x00003C40, 0x403C0000 ],   /*"c",2*/
  [ 0x04043C44, 0x443C0000 ],   /*"d",3*/
  [ 0x00003C7C, 0x403C0000 ],   /*"e",4*/
  [ 0x3C20FC20, 0x20200000 ],   /*"f",5*/
  [ 0x00003C44, 0x443C0438 ],   /*"g",6*/
  [ 0x40405C64, 0x44440000 ],   /*"h",7*/
  [ 0x10007010, 0x10100000 ],   /*"i",8*/
  [ 0x08007808, 0x08080870 ],   /*"j",9*/
  [ 0x40404C58, 0x784C0000 ],   /*"k",10*/
  [ 0x70101010, 0x10100000 ],   /*"l",11*/
  [ 0x0000FE92, 0x92920000 ],   /*"m",12*/
  [ 0x00005C64, 0x44440000 ],   /*"n",13*/
  [ 0x00007884, 0x84780000 ],   /*"o",14*/
  [ 0x00007844, 0x44784040 ],   /*"p",15*/
  [ 0x00003C44, 0x443C0404 ],   /*"q",16*/
  [ 0x00005C60, 0x40400000 ],   /*"r",17*/
  [ 0x00007C60, 0x1C7C0000 ],   /*"s",18*/
  [ 0x0020FC20, 0x203C0000 ],   /*"t",19*/
  [ 0x00004444, 0x4C740000 ],   /*"u",20*/
  [ 0x00008244, 0x28100000 ],   /*"v",21*/
  [ 0x000092AA, 0xEA440000 ],   /*"w",22*/
  [ 0x00004830, 0x30480000 ],   /*"x",23*/
  [ 0x00008448, 0x703020C0 ],   /*"y",24*/
  [ 0x0000FC08, 0x70FC0000 ],   /*"z",25*/
